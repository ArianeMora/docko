...
base_dir = '/Users/arianemora/Documents/code/docko/docko/data/casey/'
label = 'docking_heme'
...
score = dock(sequence='', protein_name=label, smiles=smiles, ligand_name='vinyluracil', residues=[86, 89, 178, 177], 
